;(function ($, window, undefined) {
  ...
  if ($("#demoEditor").length) {
    ...
    var updateDemoPreview = function() {
        ...
        demoIframeContents.find('head').html('<link rel="stylesheet" href="/media/css/iframe.css"><link rel="stylesheet" href="/media/css/foundation.min.css">');
  ...
  if ($("#editor").length) {
    ...
    var updatePreview = function() {
        ...
        iframeContents.find('head').html('<link rel="stylesheet" href="/media/css/iframe.css"><link rel="stylesheet" href="/media/css/foundation.min.css">');
  ...
  if ($("#quizEditor").length) {
    ...
    var updateQuizPreview = function() {
        ...
        quizIframeContents.find('head').html('<link rel="stylesheet" href="/media/css/iframe.css"><link rel="stylesheet" href="/media/css/foundation.min.css">');
