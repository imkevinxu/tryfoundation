;(function ($, window, undefined) {
  ...
  if ($("#demoEditor").length) {
    ...
    var updateDemoPreview = function() {
        ...
        demoIframeContents.find('head').html('<link rel="stylesheet" href="/media/css/iframe.css">');
  ...
  if ($("#editor").length) {
    ...
    var updatePreview = function() {
        ...
        iframeContents.find('head').html('<link rel="stylesheet" href="/media/css/iframe.css">');
  ...
  if ($("#quizEditor").length) {
    ...
    var updateQuizPreview = function() {
        ...
        quizIframeContents.find('head').html('<link rel="stylesheet" href="/media/css/iframe.css">');
