...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'librarian_lessoncompletion', (
        ...
        db.send_create_signal(u'librarian', ['LessonCompletion'])

        # Adding field 'Lesson.group'
        db.add_column(u'librarian_lesson', 'group',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'librarian_lessoncompletion')

        # Deleting field 'Lesson.group'
        db.delete_column(u'librarian_lesson', 'group')
